...
from utils import MODEL_NAME, DEVICE, MODEL_ID
...
# Testing the tokenizer function with a simple call
# tokenized_function({'question':"What is LLM?", 'answer':'LLMs are large language Models'})
# import pandas as pd
# from datasets import Dataset
# from utils import PROCESSED_DATA_DIR
# train_df = pd.read_csv(os.path.join(PROCESSED_DATA_DIR, "train.csv"))
# train_data = Dataset.from_pandas(train_df)
# train_data.map(tokenized_function, batched=True)
